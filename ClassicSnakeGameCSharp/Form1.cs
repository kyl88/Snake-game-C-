...
namespace ClassicSnakeGameCSharp
{
    public partial class Form1 : Form
    {
        ...
        private void updateGraphics(object sender, PaintEventArgs e)
        {
            ...
            {
                string gameOver = "Game Over" + "Final Score" + Settings.Score + "Press enter to Restart";
        ...
        private void updateScreen(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else if (Input.KeyPress(Keys.Up) && Settings.direction != Directions.Left)
                ...
                else if (Input.KeyPress(Keys.Down) && Settings.direction != Directions.Down)
                {
